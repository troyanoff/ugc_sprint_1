...
clickhouse-client --query "\
    ...
    Engine=ReplicatedMergeTree('/clickhouse/tables/events_shard1/click_events', 'replica_1') \
...
clickhouse-client --query "\
    ...
    Engine=ReplicatedMergeTree('/clickhouse/tables/events_shard1/view_events', 'replica_1') \
    PARTITION BY toYYYYMMDD(event_dt) ORDER BY event_dt"
...
clickhouse-client --query "\
    ...
    Engine=ReplicatedMergeTree('/clickhouse/tables/events_shard1/quality_change_events', 'replica_1') \
    PARTITION BY toYYYYMMDD(event_dt) ORDER BY event_dt"
...
clickhouse-client --query "\
    ...
    Engine=ReplicatedMergeTree('/clickhouse/tables/events_shard1/video_progress_events', 'replica_1') \
    PARTITION BY toYYYYMMDD(event_dt) ORDER BY event_dt"
...
clickhouse-client --query "\
    ...
    Engine=ReplicatedMergeTree('/clickhouse/tables/events_shard1/query_events', 'replica_1') \
    PARTITION BY toYYYYMMDD(event_dt) ORDER BY event_dt"
